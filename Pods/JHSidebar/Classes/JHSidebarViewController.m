...
- (void)setup {
    ...
    _leftOpenAnimationLength = 0.2;
    _leftCloseAnimationLength = 0.2;
    _rightOpenAnimationLength = 0.2;
    _rightCloseAnimationLength = 0.2;
    
    _leftSidebarWidth = 250.0f;
    _rightSidebarWidth = 0;
}
